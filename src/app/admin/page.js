            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex w-full sm:w-auto overflow-x-auto scrollbar-hide gap-2 sm:gap-0 sm:border sm:border-zinc-300 sm:rounded-lg sm:bg-white/80 sm:backdrop-blur sm:shadow-sm flex-nowrap shrink-0 pb-2 sm:pb-0 mb-1 sm:mb-0">
                ...
                <button
                  ...
                  className={`px-4 py-2 text-sm font-bold transition-colors flex items-center justify-center gap-1.5 whitespace-nowrap rounded-full sm:rounded-none border sm:border-y-0 sm:border-r-0 sm:border-l sm:border-zinc-200 flex-shrink-0 ${

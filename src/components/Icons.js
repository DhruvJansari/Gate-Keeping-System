  ...
  return (
    ...
    >
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M3 5a2 2 0 012-2h2.28a2 2 0 011.94 1.515l.516 2.066a2 2 0 01-.45 1.888l-1.27 1.27a16 16 0 006.364 6.364l1.27-1.27a2 2 0 011.888-.45l2.066.516A2 2 0 0121 16.72V19a2 2 0 01-2 2h-1C9.163 21 3 14.837 3 7V5z"
      />
    </svg>
  );
}
...
// Stage Truck icon - for transaction stages
export function StageTruckIcon({ completed, className = "" }) {
  return (
    <span
...
// Loading goods icon (box with arrow up)
export function LoadingGoodsIcon({ className = "h-5 w-5" }) {
  return (
    <svg
      className={className}
      fill="none"
    ...
    >
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-9 4h4m-2-2v4"
      />
    </svg>
  );
}

// Unloading goods icon (box with arrow down)
export function UnloadingGoodsIcon({ className = "h-5 w-5" }) {
  return (
    <svg
      className={className}
      fill="none"
    ...
    >
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-7 4v4m0 0l-2-2m2 2l2-2"
      />
    </svg>
  );
}
...
// Parking icon
export function ParkingIcon({ className = "h-5 w-5" }) {
  return (
    <svg
      className={className}
      fill="none"
...
// Delete / Trash icon
export function DeleteIcon({ className = "h-5 w-5" }) {
  return (
    <svg
      className={className}
      fill="none"
...
// View / Eye icon (alias for consistency)
export function ViewIcon({ className = "h-5 w-5" }) {
